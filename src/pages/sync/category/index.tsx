...
import { CategorySynchronizationDetails, DbSCategory, DbTCategory, FreshSCategory, FreshTCategory } from "../../../api/types";
        ...
        {apiSmCategories && (
          <DataTable className="my-datatable" value={apiSmCategories} header="SM Categories">
            ...
            <Column field="action" header="Action" body={(rowData) => (
              <button onClick={() => upsertCategory(rowData)}><FontAwesomeIcon icon={faArrowRight}/></button>
